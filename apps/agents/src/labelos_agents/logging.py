...
def _service_name(default: str = "labelos-agents") -> str:
    return os.getenv("AGENTS_SERVICE_NAME") or os.getenv("SERVICE_NAME") or default
...
async def request_logging_middleware(
    ...
    logger = logging.getLogger("labelos_agents.request")
