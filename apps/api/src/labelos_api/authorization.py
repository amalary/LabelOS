...
CAPABILITY_DEPARTMENTS: dict[Capability, frozenset[str]] = {
    ...
    Capability.marketing_account_view: frozenset({"marketing", "management"}),
    Capability.marketing_account_manage: frozenset({"marketing", "management"}),
    ...
    Capability.marketing_content_approve: frozenset({"marketing", "management"}),
